...
#ifndef INCLUDED_I_Leak_TC_HPP
#define INCLUDED_I_Leak_TC_HPP
...
class I_Leak_TC {
 public:
  static void current(state_type &variables, state_type &dxdt, const double t, unsigned index) {    
  	double eleak=-70, ekleak=-100, gleak=0.01, gkleak=0.0028;
    ...
    double v = variables[v_index];
   												 ...
   												 // Current
     engine::neuron_value(index, "I_Leak_TC", -1*(gleak*(v-eleak) + gkleak*(v-ekleak)));
